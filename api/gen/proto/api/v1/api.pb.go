...
const file_proto_api_v1_api_proto_rawDesc = "" +
	...
	"\bPingPong\x12\x17.api.v1.PingPongRequest\x1a\x18.api.v1.PingPongResponseB\xa1\x01\n" +
	"\n" +
	"com.api.v1B\bApiProtoP\x01ZPgithub.com/dev-shimada/connect-http-method-playground/api/gen/proto/api/v1;apiv1\xa2\x02\x03AXX\xaa\x02\x06Api.V1\xca\x02\x06Api\\V1\xe2\x02\x12Api\\V1\\GPBMetadata\xea\x02\aApi::V1b\x06proto3"
